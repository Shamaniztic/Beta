...
namespace TbsFramework.Grid
{
    ...
    public partial class CellGrid : MonoBehaviour
    {
        ...
        private void OnUnitHighlighted(object sender, EventArgs e)
        {
            ...
            UnitHighlighted?.Invoke(sender, e);
        }
        ...
        private void OnUnitDehighlighted(object sender, EventArgs e)
        {
            ...
            UnitDehighlighted?.Invoke(sender, e);
        }
        ...
        public void AddUnit(Transform unit, Cell targetCell = null, Player ownerPlayer = null)
        {
            ...
            if (ownerPlayer != null)
            {
                Debug.Log($"Assigning PlayerNumber {ownerPlayer.PlayerNumber} to unit {unit.GetComponent<Unit>().name}");
                unit.GetComponent<Unit>().PlayerNumber = ownerPlayer.PlayerNumber;
            }
            else
            {
                Debug.LogWarning($"No owner player provided for unit {unit.GetComponent<Unit>().name}");
            }
